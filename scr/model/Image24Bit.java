...
public class Image24Bit implements Image {
  ...
  @Override
  public Image fromPixels(Pixel[][] pixels) {
    return new Image24Bit(pixels);
  }

  /**
   * Checks the validity of a 2-dimensional array of pixels for an image.
   ...
   */
  private static void ensureValidPixels(Pixel[][] channel) throws IllegalArgumentException {
