...
public class DownscaleOperationTest {
  ...
  public void testDownScaleDifferentAspectRatio() {
    ...
    assertEquals(new RgbPixel(190, 255, 87), output.getPixelAt(1, 0));
    assertEquals(new RgbPixel(3, 38, 199), output.getPixelAt(2, 0));
    assertEquals(new RgbPixel(190, 255, 87), output.getPixelAt(3, 0));
    assertEquals(new RgbPixel(3, 38, 199), output.getPixelAt(0, 1));
    assertEquals(new RgbPixel(190, 255, 87), output.getPixelAt(1, 1));
    assertEquals(new RgbPixel(3, 38, 199), output.getPixelAt(2, 1));
    assertEquals(new RgbPixel(190, 255, 87), output.getPixelAt(3, 1));
    assertEquals(new RgbPixel(3, 38, 199), output.getPixelAt(0, 2));
    assertEquals(new RgbPixel(190, 255, 87), output.getPixelAt(1, 2));
    assertEquals(new RgbPixel(3, 38, 199), output.getPixelAt(2, 2));
    assertEquals(new RgbPixel(190, 255, 87), output.getPixelAt(3, 2));
  }
}