...
public class DownscaleOperationTest {
  ...
  public void testConstructorInvalidHighScale() {
    new DownscaleOperation(1.1);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testConstructorInvalidZeroScale() {
    new DownscaleOperation(0);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testConstructorInvalidNegativeScale() {
    new DownscaleOperation(-0.5);
  }

  @Test
  public void testDownscaleScale1() {
    Image image = ImageExamples.rainbow(10, 12);
    Image output = new DownscaleOperation(1).apply(image);
  ...
  @Test
  public void testDownscaleScaleHalf() {
    Image image = ImageExamples.rainbow(5, 7);
    Image output = new DownscaleOperation(0.5).apply(image);
